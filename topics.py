...
original_topics = [
    #"Drug importation from foreign countries jeopardizes safety controls and the domestic pharma industry.",
    ...
    "Space tourism should be allowed to start even if safety rules aren't fully set up at the beginning",

    #"Lifespan extension would make inequities worse and should be pursued.",
